      ...
      <div class="post-base-1">
        ...
        <div class="post-base-1 comment_option_footer">
          ...
          <div class="emoji-panel">
             <button @click="createReply" class="main-btn color btn-hover"><i class="fa fa-paper-plane" aria-hidden="true"></i>
    ...
    let commentID = this.$props.comment_id;
     ...
     let form = new FormData();
      ...
      axios.get("/sanctum/csrf-cookie").then((response) => {
        ...
        axios
          .post(`api/comment/${commentID}/reply`,form,headers)
          .then((response) => {
            console.log(response.data);
            if (response.status == 200) {
              this.reply = "";
              document.getElementById('file').value = "";
              console.log('Reply created succesfuly');
            }
          })
